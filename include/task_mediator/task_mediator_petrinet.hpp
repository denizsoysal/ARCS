...
#include <coordination-libraries/petrinet/petrinet.h> //need to include it in CMake!
...
petrinet_t task_mediator_create_bringup_petrinet(const char *name); //the name bringup can be changed as it was created for the mobile platform specifically
